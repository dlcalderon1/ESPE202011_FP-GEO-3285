...
public class HW07Functions {
    ...
    public static void main(String[] args) {
        ...
        int result = computeParabola(indVariable);
        ...
        System.out.printf("Enter a stop to the multiplication table: ");
        int stop = keyboard.nextInt();
        printTheMultiplicationTable(number, stop);
    ...
    public static int computeParabola(int indVariable) {
        int result;
        result = indVariable * indVariable + 2 * indVariable + 1;
        return result;
    }

    public static void printTheMultiplicationTable(int number, int stop) {
